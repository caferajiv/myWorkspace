...
public class Heap1 {
	...
	public Heap1(int capacity, int heap_type){
	...
	public static Heap1 buildHeap(int[] arr)
	{
		Heap1 heap = new Heap1(arr.length,Heap1.MAX_HEAP);
	...
	public static void main(String[] args) {
		Heap1 heap =	buildHeap(new int[]{3, 5, 7, 14, 89, 4, 56, 67, 34, 24, 17, 9 , 23});
